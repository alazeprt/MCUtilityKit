...
import com.alazeprt.minecraftutils.account.MicrosoftAccount;
...
import com.alazeprt.minecraftutils.version.Instance;
...
public class Vanilla {
    public static String extractNatives(File root, String instance) throws Exception {
        Gson gson = new Gson();
        ...
        return new File(versionFolder, folderName).getAbsolutePath();
    }

    public static void launch(Java java, File root, Instance instance, Account account, String nativesFolder) throws Exception {
        Gson gson = new Gson();
        Map<String, Object> json = gson.fromJson(new InputStreamReader(
        ...
        librariesString.append("C:\\Users\\alazeprt\\IdeaProjects\\MinecraftUtils\\.minecraft\\versions\\" + instance.name() + "\\" + instance.name() + ".jar");
    ...
    static class ArgumentHandler {
        ...
        public ArgumentHandler(String root, String nativesFolder, String assetIndex, String libraries, Instance instance, Account account) {
            ...
            this.launcherName = "MinecraftUtils";
