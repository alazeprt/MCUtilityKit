...
import top.alazeprt.minecraftutils.account.AccountType;
...
import top.alazeprt.minecraftutils.version.Manifest;
import top.alazeprt.minecraftutils.version.Version;
...
public class BasicStorage {
    ...
    public BasicStorage() {
        this.file = new File(".minecraftutils.json");
    }
