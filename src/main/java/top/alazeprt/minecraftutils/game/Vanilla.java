...
import top.alazeprt.minecraftutils.account.MicrosoftAccount;
import top.alazeprt.minecraftutils.java.Java;
import top.alazeprt.minecraftutils.util.FileUtil;
import top.alazeprt.minecraftutils.util.Result;
import top.alazeprt.minecraftutils.util.UUIDUtil;
import top.alazeprt.minecraftutils.version.Instance;
